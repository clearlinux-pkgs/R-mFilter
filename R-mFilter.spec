...
Version  : 0.1.3
Release  : 1
URL      : https://cran.r-project.org/src/contrib/mFilter_0.1-3.tar.gz
Source0  : https://cran.r-project.org/src/contrib/mFilter_0.1-3.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1530472661
